...
public class AppFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        isFirstRun = prefs.getBoolean("1.2.7", true);
        if (isFirstRun) {
            showUpdateInfo();
        }
        isFirstRun = false;

        prefs.edit().putBoolean("1.2.7", isFirstRun).commit();

        prefs.edit().remove("1.2.6").commit();
...
//                                break;
    ...
    void showUpdateInfo() {
        ...
        alertDialog.setMessage("Versiya: 1.2.7\n*Reseptlərim bölməsi əlavə olundu\n* ASAN login imkanı əlavə olundu\n* Umumi yaxşılaşdırmalar");
        alertDialog.show();
    }

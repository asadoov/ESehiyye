 ...
 * Use the {@link TibbiTehsil#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TibbiTehsil extends Fragment {
    ProgressDialog mWaitingDialog;

    public static TibbiTehsil newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_tibbi_tehsil, container, false);
        TextView toolbarTitle = getActivity().findViewById(R.id.toolbarTitle);
        toolbarTitle.setText("Tibb təhsili proqramı çərçivəsində ixtisas üzrə müəllimlik fəaliyyəti");
                ...
                if (!nameEditText.isEmpty()) {
                    ...
                    final Thread thread = new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            final List<FeedbackStatusStruct> statusList = insert.tibbitehsilinsert(hourIndex, nameEditText, Calendar.getInstance().get(Calendar.YEAR), view);
                            if (getActivity() != null) {
                                getActivity().runOnUiThread(new Runnable() {
                                    public void run() {
